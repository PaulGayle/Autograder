...
# Should generate an error , one of the functions missing
...
def add_contact(contacts):
    ...
    phone = input('Enter Phone (format: (XXX)XXX-XXXX): ')
...
def update_contact(contacts):
    ...
    if found_contacts:
        view_contacts(found_contacts)
        first_name = input('Enter First Name to confirm the update: ')
