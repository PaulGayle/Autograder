...
# This program is a simple contact manager 
# that allows user to perform different opperations on their contacts.
# User can add, view, search, remove, and update contact infrmation.
# April 10, 2025
# CSC-121 M6Pro
